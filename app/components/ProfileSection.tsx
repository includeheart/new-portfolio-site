		...
		<div className="w-full py-8 md:py-0 bg-white dark:bg-gray-900 px-6 pt-16 sm:pt-0">
			<div className="space-y-8 text-center">
				...
				<div className="space-y-3">
					<h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Patrick Kernan</h1>
				...
				<div className="space-y-4">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<a href="mailto:pkernan18@yahoo.com" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
							pkernan18@yahoo.com
						</a>
					</div>
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<span className="text-sm text-gray-600 dark:text-gray-400">Barberton, OH</span>
					</div>

					{/* Social Links */}
					<div className="flex items-center justify-center space-x-4 pt-2">
						<a
							href="https://www.github.com/includeheart"
							target="_blank"
							rel="noopener noreferrer"
